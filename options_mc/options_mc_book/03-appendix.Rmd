...
5. Probability is a measure of the likelihood or chance that a specific event 
...
6. Expected value is a concept used in statistics to calculate the long-term 
...
7. A bootstrap sample is a sample of data that is created by randomly selecting 
...
from a smaller sample.<br><br>To create a bootstrap sample, we start by randomly 
...
all.<br><br>Bootstrap sampling is commonly used in statistics to estimate the 
...
the statistic of interest.[↩︎](#intro)

8. A Monte Carlo simulation is a computational method used to estimate the 
